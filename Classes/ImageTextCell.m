...
- (void)drawWithFrame:(NSRect)cellFrame inView:(NSView *)controlView {
	...
	[primaryText drawAtPoint:NSMakePoint(cellFrame.origin.x+cellFrame.size.height+5, cellFrame.origin.y+15) withAttributes:primaryTextAttributes];
	...
	//[secondaryText drawAtPoint:NSMakePoint(cellFrame.origin.x+cellFrame.size.height+12, cellFrame.origin.y+cellFrame.size.height/2) 
	...
	[icon drawInRect:NSMakeRect(cellFrame.origin.x+1,yOffset+1,cellFrame.size.height-1, cellFrame.size.height-1)
