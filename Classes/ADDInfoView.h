...
@class TMSliderControl, ADDScheduleConfig, DSCloneTask;

@interface ADDInfoView : MGAViewController <ADDExclusionsVCDelegate, ADDCloneWindowDelegate>
{
...
extern const NSString *ADDSchedulerOnNotification;
extern const NSString *ADDSchedulerOffNotification;
